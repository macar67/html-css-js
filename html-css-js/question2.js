...
function optimizeFunction(func) {
  ...
  // Bu soruda bi sorun olabilir açıkçası tam olarak anlamadım.Zamanımda az kaldığı için mail olarak yazmıyorum ama  "anOptimizedFunc(input)" içindeki input değerine ulaşmak için sanki bi şeyler eksik.Zaten bu haliyle de yazdırdığımızda  " console.log("Doing expensive task...:", result);" buradki result değeri NaN dönüyor!!
